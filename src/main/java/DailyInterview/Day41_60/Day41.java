...
public class Day41 {
    public double[] intersection(int[] start1, int[] end1, int[] start2, int[] end2) {
        //不能直接做除法，因为斜率可能不存在，要用乘法进行判定
        double k1 = (end1[1] - start1[1]) / (end1[0] - end1[0]);
        double k2 = (end2[1] - start2[1]) / (end2[0] - end2[0]);
        double b1 = start1[1] - k1 * end1[0];
        double b2 = start2[1] - k2 * end2[0];
        return new double[0];
    }
